...
void RobotMap::init() {
	...
	clawshooterSol1 = new Solenoid(1, 7);
	lw->AddActuator("Claw", "shooterSol1", clawshooterSol1);
	
	clawshooterSol2 = new Solenoid(1, 8);
	lw->AddActuator("Claw", "shooterSol2", clawshooterSol2);
	

	// END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
	
	armrollerrelay1 = new Relay(1, 6,Relay::kBothDirections);
	...
	armSol1 = new Solenoid(1, 5);
	lw->AddActuator("Arm", "Sol1", armSol1);
	
	armSol2 = new Solenoid(1, 6);

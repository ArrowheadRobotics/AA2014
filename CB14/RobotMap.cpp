...
Relay* RobotMap::led = NULL;

Solenoid* RobotMap::clawtriggerSol = NULL;
Solenoid* RobotMap::clawtwoshotSol1 = NULL;
Solenoid* RobotMap::clawtwoshotSol2 = NULL;
Solenoid* RobotMap::clawfourshotSol1 = NULL;
Solenoid* RobotMap::clawfourshotSol2 = NULL;
Solenoid* RobotMap::clawarmSol = NULL;
...
//	lw->AddActuator("Claw", "triggerSol2", clawtriggerSol2);
	...
	clawtriggerSol = new Solenoid(moduleONE, port1TRIGGER);
	lw->AddActuator("Claw", "triggerSol", clawtriggerSol);
	
	clawtwoshotSol1 = new Solenoid(moduleONE, port1TWOSHOT1);
	lw->AddActuator("Claw", "twoshotSol1", clawtwoshotSol1);
	
	clawtwoshotSol2 = new Solenoid(moduleONE, port1TWOSHOT2);
	lw->AddActuator("Claw", "twoshotSol2", clawtwoshotSol2);
	
	clawfourshotSol1 = new Solenoid(moduleONE, port1FOURSHOT1);
	lw->AddActuator("Claw", "fourshotSol1", clawfourshotSol1);
	
	clawfourshotSol2 = new Solenoid(moduleONE, port1FOURSHOT2);
	lw->AddActuator("Claw", "fourshotSol2", clawfourshotSol2);
	
	clawarmSol = new Solenoid(moduleONE, port1ARM);
	lw->AddActuator("Claw", "armSol1", clawarmSol);
...
//	lw->AddActuator("Claw", "shooterSol2", clawshooterSol2);
	...
	led = new Relay(moduleONE, portLED);
}

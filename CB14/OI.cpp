...
OI::OI() {
	...
	joyPad = new Joystick(3); //add gamepad
	//following lines add buttons to each joystick and assign a command to be run when that button is pressed
